  ...
  return (
    <div className="container relative mb-20 max-w-6xl py-6 lg:py-10">
      ...
      <div className="flex-1 mt-6 text-center text-muted-foreground lg:text-start xl:text-base">
        <p>
        This privacy policy ("<strong>Privacy Policy</strong>") explains how we process and protect your personal data when you use this Website provided via https://deficollective.org or DeFi Scan provided at [URL] (collectively the "<strong>Website</strong>").
        </p>
        ...
        <p className="mt-4">
        The Website is operated by DeFi Collective, Dammstrasse 16, 6300 Zug (the "<strong>Collective</strong>", "<strong>we</strong>", "<strong>our</strong>", or "<strong>us"</strong>). The Collective is the controller for the data processing described below.
        </p>
      ...
      <div className="flex-1 mt-6 text-center text-muted-foreground lg:text-start xl:text-base">
        ...
        <ul className="mt-4 pl-5 list-decimal list-outside">
          ...
          <li><strong>Contract</strong>: To perform our contractual obligations or take steps linked to a contract (e.g., our Terms) with you. In particular:</li>
          ...
          <li className="mt-2"><strong>Consent</strong>: We may rely on your freely given consent at the time you provided your personal data. In particular:</li>

          <ul className="mt-2 pl-5 list-disc list-outside">
            <li>To answer your requests, your reach-outs or similar contact you may establish with us.</li>
            <li>To collaborate with you based on your requests in connection with DeFi Scan.</li>
            <li>To provide you with news, newsletters, and general information about our activities and our mission (note that we do not currently have a newsletter, and will never send you any newsletter unless you specifically request it from us).</li>
          </ul>

          <li className="mt-2"><strong>Legitimate interests</strong>: We may rely on legitimate interests based on our assessment that the processing is fair and reasonable and does not override your interests or fundamental rights and freedoms. In particular:</li>

          <ul className="mt-2 pl-5 list-disc list-outside">
            <li>To maintain and improve our Website.</li>
            <li>To extend our activities in support of our mission and vision.</li>
          </ul>

          <li className="mt-2"><strong>Necessity for compliance with legal obligations</strong>: To meet regulatory and public interest obligations. In particular:</li>
      ...
      <div className="flex-1 mt-6 text-center text-muted-foreground lg:text-start xl:text-base">
        ...
        <li>To comply with a legal obligation (i.e., if required by law or in response to valid requests by public authorities, such as a court or government agency);</li>
        <li>To protect the security of the Website and defend our rights or property;</li>
        <li>To prevent or investigate possible wrongdoing in connection with us;</li>
      ...
      <div className="flex-1 mt-6 text-center text-muted-foreground lg:text-start xl:text-base">
        ...
        <ul className="mt-4 pl-5 list-disc list-outside">
          <li>Right of access: You have a right to request a copy of your personal data, which we will provide to you in an electronic form.</li>
          <li>Right to amendment: You have the right to ask us to correct our records if you believe they contain incorrect or incomplete information about you.</li>
          <li>Right to withdraw consent: If you have provided your consent to the processing of your personal data, you have the right to withdraw your consent with effect for the future. Once we have received notification that you have withdrawn your consent, we will no longer process your information for the purpose(s) to which you initially consented unless there is another legal basis for processing.</li>
          <li>Right to erasure: You have the right to request that we delete your personal data when it is no longer necessary for the purposes for which it was collected or when it was unlawfully processed.</li>
          ...
          <li>Right to portability: You have the right to request that we transmit your personal data to another data controller in a standard format such as Excel, where this is data which you have provided to us and where we are processing it on the legal basis of your consent or to perform our contractual obligations.</li>
          <li>Right to object to processing: Where the legal basis for our processing of your personal data is our legitimate interest, you have the right to object to such processing on grounds relating to your particular situation. We will abide by your request unless we have a compelling legal basis for the processing which overrides your interests or if we need to continue to process the personal data for the exercise or defence of a legal claim.</li>
          <li>Right to lodge a complaint with a supervisory authority: You have the right of appeal to a data protection supervisory authority if you believe that the processing of your personal data violates data protection law. The competent data protection authority in Switzerland is the Federal Data Protection and Information Commissioner (<a href="http://www.edoeb.admin.ch/edoeb/en/home.html">www.edoeb.admin.ch/edoeb/en/home.html</a>). For the EU, you can exercise this right, for example, before a supervisory authority in the Member State of your residence, your place of work or the place of the alleged infringement.</li>
        </ul>
      </div>
      ...
      <div className="flex-1 mt-6 text-center text-muted-foreground lg:text-start xl:text-base">
        ...
        <ul className="mt-4 pl-5 list-disc list-outside">
          <li>Discord: <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://discord.com/privacy">Privacy Policy</a></li>
          <li>X (Twitter):<a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://twitter.com/en/privacy"> Privacy Policy</a></li>
          <li>YouTube:<a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://policies.google.com/privacy?"> Privacy Policy</a></li>
          <li>LinkedIn:<a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://www.linkedin.com/legal/privacy-policy?"> Privacy Policy</a></li>
        </ul>
      </div>
